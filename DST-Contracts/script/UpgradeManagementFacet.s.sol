...
contract UpgradeManagementFacet is Script {
    ...
    function run() external {
        ...
        if (currentManagementFacet == address(0)) {
            ...
            // Define new function selectors (including new getter functions)
            bytes4[] memory newGetterSelectors = new bytes4[](3);
            newGetterSelectors[0] = ManagementFacet.xchainGetMessenger.selector;
            newGetterSelectors[1] = ManagementFacet.xchainGetDstEid.selector;
            newGetterSelectors[2] = ManagementFacet.xchainGetOptions.selector;
            ...
            // 2. Add new getter functions
            cuts[1] = IDiamondCut.FacetCut({
                facetAddress: address(newManagementFacet),
                action: IDiamondCut.FacetCutAction.Add,
                functionSelectors: newGetterSelectors
            });
